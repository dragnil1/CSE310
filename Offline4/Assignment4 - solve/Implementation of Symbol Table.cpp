...
class SymbolInfo
{
    string Name, Type, state, TypeSpecifier, Code, symbol, Scope;
    vector<string> parameters, parameterName, parameterScope;
    int arraySize, parameterNumber;
    SymbolInfo *next;
public:
    ...
    vector<string> getParameterName()
    {
    ...
    void setParameters(vector<string> pararmeters)
    {
        this->parameters = pararmeters;
    }
    ...
    {
        this->parameterName.push_back(parameterName);
    }

    void addParameterScope(string parameterScope)
    {
        this->parameterScope.push_back(parameterScope);
    }

    vector<string> getParameterScope()
    {
        return parameterScope;
    }

    void setParameterNumber(int parameterNumber)
    {
...
public:
    ...
    bool Insert(string name, string type)
    {
        ...
        {
            //output << endl;
            //output << name + " already exists in current ScopeTable" << endl;
            return false;
        }
    }
...
public:
    ...
    {
        string id;
        id = currentScope->getId() + "_" + to_string(currentScope->getNumberOfDeletedChild() + 1);
